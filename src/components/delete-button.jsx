const DeleteButton = ({ type, onClick }) => {
  return (
    ...
    >
      <span className="text-xs font-medium text-gray-300 transition-colors duration-300 ease-in-out group-hover:text-gray-500">
        Delete
      </span>
      <svg
        className="w-4 fill-gray-300 transition-all duration-300 ease-in-out group-hover:fill-red-400"
        version="1.1"
        id="Capa_1"
